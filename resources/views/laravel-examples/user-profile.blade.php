...
<div>
    <div class="container-fluid">
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            <div class="row gx-4">
                <div class="col-auto">
                    <div style="background-color: #eee" class="avatar avatar-xl position-relative">
                        <span style="font-size: 1.25rem; color:#344767">{{ Auth::user()->first_name[0]  }}</span><!--<img src="../assets/img/bruce-mars.jpg" alt="..." class="w-100 border-radius-lg shadow-sm">-->
                        <a href="javascript:;" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
                            <i class="fa fa-pen top-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Modifier l'image"></i>
                        </a>
                    </div>
                </div>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="/update-profil" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user-firstname" class="form-control-label">Nom</label>
                                <div class="@error('user.firstname')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->first_name }}" type="text" placeholder="Nom" id="user-firstname" name="first_name">
                                        @error('firstname')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user-lastname" class="form-control-label">Prénom</label>
                                <div class="@error('user.lastname')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->last_name }}" type="text" placeholder="Prénom" id="user-lastname" name="last_name">
                                        @error('lastname')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.phone" class="form-control-label">Téléphone</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.location" class="form-control-label">Pays</label>
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Pays" id="name" name="location" value="{{ auth()->user()->country }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="@error('user.about')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="about" rows="3" placeholder="Ecrivez quelque chose à propos de vous" name="description_profil">{{ auth()->user()->userable->description_profil }}</textarea>
                        </div>
                    </div>
                    @if (auth()->user()->role == "therapeute")
                    <div class="form-group">
                        <label for="services">A propos de mes services</label>
                        <div class="@error('user.services')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="services" rows="3" placeholder="Ecrivez quelque chose à propos de vos services" name="description_services">{{ auth()->user()->userable->description_services }}</textarea>
                        </div>
                    </div>
                    @endif
