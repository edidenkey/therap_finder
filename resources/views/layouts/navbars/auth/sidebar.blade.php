  ...
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
      <!--<img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="...">-->
        <span class="ms-3 font-weight-bold">Theraplib Admin</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{Auth::user()->role == "admin" ? 'Profil & Gestion des utilisateurs': 'Profil'}}</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('mon-profil') ? 'active' : '') }} " href="{{ url('mon-profil') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('gestion-des-utilisateurs') ? 'active' : '') }}" href="{{ url('gestion-des-utilisateurs') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 0.75rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('gestion-des-utilisateurs') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Gestion des utilisateurs</span>
        </a>
      </li>
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Gestion des catégories</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('liste-des-categories') ? 'active' : '') }}" href="{{ url('liste-des-categories') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Gestion des disciplines</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('liste-des-disciplines') ? 'active' : '') }}" href="{{ url('liste-des-disciplines') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>box-3d-50</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Disciplines</span>
        </a>
      </li>
      @endif
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Gestion des produits</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('liste-des-produits') ? 'active' : '') }}" href="{{ url('liste-des-produits') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 0.75rem;" class="fas fa-lg fa-cart-plus ps-2 pe-2 text-center text-dark {{ (Request::is('liste-des-produits') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
      ...
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Gestion des consultations</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('liste-des-consultations') ? 'active' : '') }}" href="{{ url('liste-des-consultations') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 0.75rem;" class="fas fa-lg fa-calendar ps-2 pe-2 text-center text-dark {{ (Request::is('liste-des-consultations') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
      ...
      @endif
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{Auth::user()->role == "therapeute" ? 'Liste des abonnements' : 'Gestion des abonnements'}}</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('liste-des-abonnements') ? 'active' : '') }}" href="{{ url('liste-des-abonnements') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
