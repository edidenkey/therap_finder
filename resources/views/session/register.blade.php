      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Vous pouvez créer votre compte en tant que thérapeute afin de gérer vos opérations.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body pt-4 p-3">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Nom" name="first_name" id="name" aria-label="First_name" aria-describedby="first_name" value="{{ old('first_name') }}">
                      @error('first_name')
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Prénom" name="last_name" id="last_name" aria-label="Last_name" aria-describedby="last_name" value="{{ old('last_name') }}">
                      @error('last_name')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Pays" name="country" id="country" aria-label="Country" aria-describedby="country" value="{{ old('country') }}">
                      @error('country')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Région" name="region" id="region" aria-label="Region" aria-describedby="region" value="{{ old('region') }}">
                      @error('region')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Département" name="department" id="department" aria-label="Department" aria-describedby="department" value="{{ old('department') }}">
                      @error('department')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Rue" name="street" id="street" aria-label="street" aria-describedby="name" value="{{ old('street') }}">
                      @error('street')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Téléphone" name="phone" id="phone" aria-label="Phone" aria-describedby="phone" value="{{ old('phone') }}">
                      @error('phone')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Code postal" name="postal_code" id="postal_code" aria-label="postal_code" aria-describedby="name" value="{{ old('postal_code') }}">
                      @error('postal_code')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Nom d'utilisateur" name="username" id="username" aria-label="Username" aria-describedby="username" value="{{ old('username') }}">
                      @error('username')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  @error('agreement')
                    <p class="text-danger text-xs mt-2">Veuillez accepter les conditions avant de vous inscrire.</p>
                  @enderror
                </div>
