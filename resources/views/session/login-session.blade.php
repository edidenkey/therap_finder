            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Connectez vous pour accéder à votre espace personnel<br></p>
                  <p class="mb-0">Ou créer un compte gratuitement</p>
                </div>
                <div class="card-body">
                  <form role="form" method="POST" action="/session">
                    ...
                    <div class="mb-3">
                      <input type="password" class="form-control" name="password" id="password" placeholder="Password" aria-label="Mot de passe" aria-describedby="password-addon">
                      @error('password')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
