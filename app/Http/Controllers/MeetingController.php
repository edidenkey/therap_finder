...
class MeetingController extends BaseController
{
    ...
    public function show()
    {
        ...
        $user_meetings = Meeting::where('therap_id', $id)->get();
        $meetings = (Auth::user()->role == "admin") ? $all_meetings : $user_meetings ;
        return view('meetings/list-meetings',compact('meetings'));
    }
